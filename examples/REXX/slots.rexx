  ...
  if view.1 = view.2 & view.1 = view.3 
   then 
    do 
      ...
      say '            ' 
      say ' Winnings will be deposited in your safe deposit box'
      say '            ' 
...
say '    safe box key to deposit winnings' 
say '    --------------------------------' 
...
k.3 = attempts 
k.4 = fruit.f 
"allocate dataset(p3.output(#02)) file(writekey) old shr"
